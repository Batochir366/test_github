...
export const CardMoon = () => {
  return (
    <div className="w-[414px] h-[832px] rounded-[48px] bg-custom backdrop-blur-md  absolute z-20  flex justify-center ">
      <div
      ...
      >
        ...
        <div className="pt-[183.11px] flex justify-center items-center">
          <img className="absolute" src="/icon.png" alt="zurag" />
          <img className="absolute" src="/shadow.png" alt="zurag" />
        </div>
        <div className="flex absolute pt-[468px] w-[414px] pl-12 flex-col">
          <h1 className=" text-[144px] bg-customText1 bg-clip-text text-transparent">
            17°
          </h1>
          <h3 className="text-[#777cce] text-[24px]">Clear</h3>
        </div>
        <div className="flex absolute pt-[746px] w-[414px] justify-around">
          <TbHome className="size-8" />
